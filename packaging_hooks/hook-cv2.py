...
# This application only uses OpenCV for screenshots and image recognition.
# Exclude the optional video codec runtime, which adds about 29 MB unpacked.
binaries = [
    entry for entry in binaries
    if 'opencv_videoio_ffmpeg' not in os.path.basename(entry[0]).lower()
]
